    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            "config": {
                ...
                "create_github_repo": self.config.create_github_repo,
    ...
    def from_dict(cls, data: dict[str, Any]) -> "BootstrapState":
        return cls(
            config=BootstrapConfig(
                ...
                create_github_repo=data["config"].get("create_github_repo", False),
                github_owner=data["config"].get("github_owner", ""),
                github_visibility=data["config"].get("github_visibility", "private"),
            ),
